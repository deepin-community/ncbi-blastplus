#############################################################################
# $Id: CMakeChecks.srcid.cmake 672552 2023-09-11 12:35:53Z ivanov $
#############################################################################
##
...
#
if(EXISTS ${NCBITK_TREE_ROOT}/.git)
    include(FindGit)
endif()
if (GIT_FOUND)
    execute_process(
        COMMAND ${GIT_EXECUTABLE} -C ${NCBITK_TREE_ROOT} log -1 --format=%h
...
if(NOT EXISTS ${NCBITK_TREE_ROOT}/.git)
...
elseif (Subversion_FOUND)
    NCBI_Subversion_WC_INFO(${NCBITK_TREE_ROOT} TOOLKIT)
else()
    set(TOOLKIT_WC_URL "")
endif()
...
if(NOT NCBITK_BUILDTIME)
    ...
    if(EXISTS "${_tk_common_include}/ncbi_revision.h.in")
        if (WIN32 OR XCODE)
