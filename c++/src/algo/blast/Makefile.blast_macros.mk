#################################
# $Id: Makefile.blast_macros.mk 673719 2023-10-06 19:32:43Z ivanov $
...
BLAST_THIRD_PARTY_INCLUDE       = $(LMDB_INCLUDE) $(SQLITE3_INCLUDE)
BLAST_THIRD_PARTY_LIBS          = $(SQLITE3_LIBS) $(LMDB_LIBS)
BLAST_THIRD_PARTY_STATIC_LIBS   = $(SQLITE3_STATIC_LIBS) $(LMDB_STATIC_LIBS)
